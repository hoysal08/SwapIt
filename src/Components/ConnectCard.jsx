    ...
    <div>
      ...
      isitfilcoin?(<Box pl="2%" pt="5%">
        ...
        <Box maxW="sm" minH="lg" pt="5%"  borderWidth='3px' borderRadius='2xl' boxShadow="dark-lg" overflow='hidden' boxSize="sm" my="1%" backgroundColor="#191825"> 
         <Image boxSize="xs" ml="6%" pl="3%" my="2%"  src={nftmeta} alt={"NFT image"} />
         <Box px='6' py='2' >
        ...
        <Box
          ...
          color='gray.500'
        >
          {nftmeta?.contract?.name|| "Name" } &bull; {nftmeta?.contract?.symbol || "Symbol" }
        </Box>
