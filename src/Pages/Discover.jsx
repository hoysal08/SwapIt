  ...
  return (
    <div>
      <Box
        ...
        pt="3%"
        h={regroupednft.length < 2 ? "100vh" : "100%"}
      >
        <Flex direction="column">
          {regroupednft.length > 0 ? (
            regroupednft.map((e, i) => (
              <GetSwapHolder key={i} props={e} fil={isitfilcoin} />
            ))
          ) : (
            <NoNfts text="Currently, No NFT's open for swap" />
          )}
        </Flex>
      </Box>
    </div>
